      ...
      <nav className="bud-navbar">
          ...
          <div className="bud-nav-brand-icon">
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
              <path
                ...
                fill="#9fe870" fillOpacity="0.12" stroke="#9fe870"
                strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"
              />
              <path
                d="M9 16V8.5M9 8.5C9 8.5 6.5 7 6.5 5M9 8.5C9 8.5 11.5 7 11.5 5"
                stroke="#9fe870" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"
              />
            </svg>
          </div>
        ...
        <div className="bud-nav-items">
          {navItems.map((item) => (
            <button
              key={item.path}
              className={`bud-nav-item${isActive(item.path) ? ' bud-nav-item--active' : ''}`}
